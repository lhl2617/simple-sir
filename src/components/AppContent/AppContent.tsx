...
const labels: Record<InputKey, LabelInfo> = {
    b: { symbol: `\u03B2`, info: `Infectivity rate`, step: 0.001, min: 0, max: 0.50 },
    g: { symbol: `\u03B3`, info: `Recovery rate`, step: 0.001, min: 0, max: 0.50 },
    I_0: { symbol: `I\u2080`, info: `Initial proportion infected`, step: 0.001, min: 0, max: 1.0 },
    Steps: { symbol: `S`, info: `Simulation steps`, step: 1, min: 5, max: 500 },
        ...
        return colKeys
            ...
            .map((k: InputKey, idx: number) => {
                ...
                return (<Col xs={24} md={6} key={idx} className={styles.sliderCol}>
                    ...
                    <Slider {...props} onAfterChange={this.update} />
