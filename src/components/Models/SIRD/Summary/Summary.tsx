...
class Summary extends React.Component<IProps, IState> {
    render = () => {
        ...
        const { b, g, m, I_0, Steps } = input;
        const { S, I, R, D, converged } = output;
        return (
            <div>
                <div className={styles.summary}>
                    ...
                    <Row justify="center" gutter={32}>
                        ...
                        <Col xs={24} md={5} >
                            ...
                            <div>Deceased, D = {(D && D.length) ? D[D.length - 1].toFixed(3) : `0`}</div>
                        </Col>
                    </Row>
                </div>
                ...
                <div className={styles.summary}>
                    <h2>Resources</h2>
                    <div>
                        <a rel="noopener noreferrer" target="_blank" href="https://en.wikipedia.org/wiki/Compartmental_models_in_epidemiology#The_SIRD_model">Wikipedia</a>
                    </div>
                </div>
            </div>
