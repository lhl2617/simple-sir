        ...
        return (
            <div>
                ...
                <div className={styles.summary}>
                    ...
                    <div>
                        <a rel="noopener noreferrer" target="_blank" href="https://en.wikipedia.org/wiki/Compartmental_models_in_epidemiology#The_SIS_model">Wikipedia</a>
                    </div>
                </div>
            </div>
